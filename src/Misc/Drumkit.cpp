...
Drumkit::Drumkit(Microtonal *microtonal_, FFTwrapper *fft_, pthread_mutex_t *mutex_)
{
...
void Drumkit::defaultsinstrument()
{
 ...
 * Cleanup the part
 */
void Drumkit::cleanup(bool final)
{
 ...
 * Note On Messages
 */
void Drumkit::NoteOn(unsigned char note,
 ...
 * Note Off Messages
 */
void Drumkit::NoteOff(unsigned char note) //relase the key
{
    int i;
...
void Drumkit::PolyphonicAftertouch(unsigned char note,
                                unsigned char velocity,
                                int masterkeyshift)
{
    (void) masterkeyshift;
 ...
 * Controllers
 */
void Drumkit::SetController(unsigned int type, int par)
{
    switch(type) {
        case C_pitchwheel:
...
void Drumkit::RelaseSustainedKeys()
{
 ...
 */
void Drumkit::RelaseNotePos(int pos)
{
    for(int j = 0; j < NUM_KIT_ITEMS; ++j) {
 ...
 */
void Drumkit::KillNotePos(int pos)
{
 ...
 */
void Drumkit::setkeylimit(unsigned char Pkeylimit)
{
...
void Drumkit::RunNote(unsigned int k)
{
    unsigned noteplay = 0;
 ...
 * Parameter control
 */
void Drumkit::setPvolume(char Pvolume_)
{
    Pvolume = Pvolume_;
    volume  =
...
void Drumkit::setPpanning(char Ppanning_)
{
    Ppanning = Ppanning_;
 ...
 */
void Drumkit::setkititemstatus(int kititem, int Penabled_)
{
...
void Drumkit::add2XMLinstrument(XMLwrapper *xml)
{
...
void Drumkit::add2XML(XMLwrapper *xml)
{
    //parameters
...
int Drumkit::saveXML(const char *filename)
{
    XMLwrapper *xml;
    xml = new XMLwrapper();
...
int Drumkit::loadXMLinstrument(const char *filename) /*{*/
{
...
void Drumkit::applyparameters(bool lockmutex) /*{*/
{
    for(int n = 0; n < NUM_KIT_ITEMS; ++n)
...
void Drumkit::getfromXMLinstrument(XMLwrapper *xml)
{
...
void Drumkit::getfromXML(XMLwrapper *xml)
{
